...
def songs(request):
    SONGS_URL = "http://songs-sn-labs-vallejoricar.labs-prod-openshift-san-a45631dc5778dc6371c67d206ba9ae5c-0000.us-east.containers.appdomain.cloud"
    songs = req.get(f"{SONGS_URL}/song").json()
    return render(request, "songs.html", {"songs": songs["songs"]})

def photos(request):
    PHOTO_URL = "https://pictures.1yexw0x5mjzb.us-south.codeengine.appdomain.cloud"
